    ...
    foreach ($partner_meta_fields as $field) {
        ...
        echo '<tr>        
                ...
                case 'text':
                  ...
                  echo '<tr><th><label>Banners Partners Pro</label></th><td></td><td><a href="https://sellfy.com/p/F2hR/" id="F2hR" class="sellfy-buy-button">Buy now</a><script type="text/javascript" src="https://sellfy.com/js/api_buttons.js"></script>&nbsp;<span class="description">Check out new <a href="https://sellfy.com/p/F2hR/" target="_blank">features</a>.</span></td></tr>';
                break;
