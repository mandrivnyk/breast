 ...
 *
 * @package Partners Banners
 * @version 1.0.0
 * @since 	0.1.0
 */
class Partners_Banners_Layout {
	...
	public static function get_instance() {
		...
		if( null == self::$instance ) {
			self::$instance = new Partners_Banners_Layout();
		} // end if
	...
	private function __construct() {
		...
		$this->templates = array(
			'partners-banners-layout.php'     => __( 'Partners Banners Layout', $this->plugin_slug )
		);
